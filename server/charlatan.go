// generated by "charlatan Server".  DO NOT EDIT.
...
func NewFakeServerDefaultPanic() *FakeServer {
	return &FakeServer{
		...
		AddrHook: func() (ident2 string) {
			panic("Unexpected call to Server.Addr")
			return
		},
		ServeHook: func() (ident3 error) {
			panic("Unexpected call to Server.Serve")
			return
		},
		ShutdownHook: func(time.Duration) (ident5 error) {
...
func (_f2 *FakeServer) Addr() (ident2 string) {
...
func (_f3 *FakeServer) Serve() (ident3 error) {
	invocation := new(ServeInvocation)

	ident3 = _f3.ServeHook()
...
func (_f4 *FakeServer) Shutdown(ident4 time.Duration) (ident5 error) {
	invocation := new(ShutdownInvocation)

	invocation.Parameters.Ident4 = ident4

	ident5 = _f4.ShutdownHook(ident4)
...
func (_f5 *FakeServer) ShutdownCalledWith(ident4 time.Duration) (found bool) {
	for _, call := range _f5.ShutdownCalls {
		if reflect.DeepEqual(call.Parameters.Ident4, ident4) {
			found = true
			break
		}
	}
...
func (_f6 *FakeServer) AssertShutdownCalledWith(t *testing.T, ident4 time.Duration) {
	t.Helper()
	var found bool
...
func (_f7 *FakeServer) ShutdownCalledOnceWith(ident4 time.Duration) bool {
	var count int
...
func (_f8 *FakeServer) AssertShutdownCalledOnceWith(t *testing.T, ident4 time.Duration) {
	t.Helper()
	var count int
...
func (_f9 *FakeServer) ShutdownResultsForCall(ident4 time.Duration) (ident5 error, found bool) {
